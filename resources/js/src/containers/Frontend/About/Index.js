...
import {
    postNewsletter,
    resetHome,
} from "../../../store/actions/frontend/home";
import {
    postContact,
    resetContact,
} from "../../../store/actions/frontend/contact";
...
class About extends Component {
    ...
    render() {
        ...
        const servicesContent = services.map((service) => (
            <div key={JSON.stringify(service)} className="col-md-6 col-xxl-4">
                    ...
                    <div className="container">
                        <div className="row">
                            ...
                            {/* <div className="col-12">
                                ...
                                <div className="row">
                                    {cms.about.supports.elements.map(
                                        (element) => (
                                            <div
                                                key={element}
                                                className="col-md-4"
